...
if __name__ == "__main__":
    ...
    logfile = open("/Users/martinbrown/Desktop/BettingScripts/output/doublechance.html" , 'w')
    logfile.write("Odds taken from Sky Bet - Double Chance on %s %s<br>" % (today,rightnow))
    logfile.write("Using 1/1 - 11/8 - 13/10 - 13/8 - 6/4 - 11/10 - 6/5 - 5/4 - 4/3 - 8/11 - 10/13 - 8/13 - 4/6 - 10/11 - 5/6 - 4/5 - 3/4<br>")
    logfile.write("---------------------------------------------------------------------------------------------------------------------<br>")
    logfile.write('<br>')
    logfile.close()
    ...
    for w in range (1, 5, 1):
        ...
        logfile = open("/Users/martinbrown/Desktop/BettingScripts/output/doublechance.html" , 'a')
        logfile.write('<br>')
        logfile.write('<br>')
        logfile.write(day.upper())
        logfile.write(" ")
        ...
        if xit != 1 :
                    ...
                    if doublechance.find('football-live') == -1:
                        ...
                        if xits != 1 :
                            ...
                            for k in range (1, 100000, 1):
                                test1 = g.readline()
                                #get shortcut if it is a Double Chance game in prep.
                                if test1.find('id="mktsubgrp-caption-') != -1:
                                    dc = test1.split('"')
                                                                        
                                if test1.find('Double Chance') != -1:
                                    dclink = dc[5]
                                    t = 1
                                    while t == 1:
                                        test1 = g.readline()
                                        if test1.find('"nofollow"') != -1:
                                            ...
                                            if (test1.find('data-oc-price-num="1" data-oc-price-den="1"') != -1) \
                                            or (test1.find('data-oc-price-num="11" data-oc-price-den="8"') != -1) \
                                            or (test1.find('data-oc-price-num="13" data-oc-price-den="10"') != -1) \
                                            or (test1.find('data-oc-price-num="13" data-oc-price-den="8"') != -1) \
                                            or (test1.find('data-oc-price-num="6" data-oc-price-den="4"') != -1) \
                                            or (test1.find('data-oc-price-num="11" data-oc-price-den="10"') != -1) \
                                            or (test1.find('data-oc-price-num="6" data-oc-price-den="5"') != -1) \
                                            or (test1.find('data-oc-price-num="5" data-oc-price-den="4"') != -1) \
                                            or (test1.find('data-oc-price-num="4" data-oc-price-den="3"')!= -1) \
                                            or (test1.find('data-oc-price-num="8" data-oc-price-den="11"') != -1) \
                                            or (test1.find('data-oc-price-num="10" data-oc-price-den="13"') != -1) \
                                            or (test1.find('data-oc-price-num="8" data-oc-price-den="13"') != -1) \
                                            or (test1.find('data-oc-price-num="4" data-oc-price-den="6"') != -1) \
                                            or (test1.find('data-oc-price-num="10" data-oc-price-den="11"') != -1) \
                                            or (test1.find('data-oc-price-num="5" data-oc-price-den="6"') != -1) \
                                            or (test1.find('data-oc-price-num="4" data-oc-price-den="5"') != -1) \
                                            or (test1.find('data-oc-price-num="3" data-oc-price-den="4"')!= -1):
                                                #print test
                                                #print test1
                                                ...
                                                gameoutput = '<a href="%s#%s" target="sky">%s (%s)</a>' % (gamelink,dclink,gamewrite,league[4])
                                                #print gameoutput
            ...
            logfile.write('<br>')
            logfile.write('<br>')
            logfile.write("Games for " + day + ": " + str(gamesValid))
            logfile.write('<br>')
            logfile.close()
    ...
    logfile.write('<br>*****************************************************************************')
    logfile.write('<br>*****************************************************************************<br>')
    logfile.write(str(totalValid) + " games to back from " + str(gamesTotal) + " games scanned")
    logfile.write('<br>')
    logfile.close()
