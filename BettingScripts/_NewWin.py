...
if __name__ == "__main__":
    ...
    logfile = open("/Users/martinbrown/Desktop/BettingScripts/output/Bet2.html" , 'w')
    logfile.write("Odds taken from Sky Bet Win Market (in 90 mins) for Bet 2 on %s %s<br>" % (today.capitalize(),rightnow))
    ...
    for w in range (1, 6, 1):
        ...
        logfile = open("/Users/martinbrown/Desktop/BettingScripts/output/Bet2.html" , 'a')
        logfile.write('<br>')
        logfile.write('<br>')
