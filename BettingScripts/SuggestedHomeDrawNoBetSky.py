...
if __name__ == "__main__":
    logfile = open("/Users/martinbrown/Desktop/BettingScripts/output/drawnobet_home_suggested.txt" , 'w')
    logfile.write('**********************************************************************')
    logfile.write('\n')
    logfile.write("Suggested [Home] Draw no Bet Games with odds 1/1 ~ 11/8 ~ 13/10 ~ 13/8 ~ 6/4 ~ 11/10 ~ 6/5 ~ 5/4 ~ 4/3")
    logfile.write('\n')
    logfile.write('**********************************************************************')
    logfile.write('\n')
    logfile.close()
    ...
    if xit != 1 :
        ...
        for j in range (1, 10000, 1):
            ...
            if len(odds) == 5 :
                #print odds
                #Gets Bet 1
                if (odds[2] == " 1/1 ") or (odds[2] == " 11/8 ") or (odds[2] == " 13/10 ") or (odds[2] == " 13/8 ") or (odds[2] == " 6/4 ") or (odds[2] == " 11/10 ") or (odds[2] == " 6/5 ") or (odds[2] == " 5/4 ") or (odds[2] == " 4/3 "):
                    print "Home Win" + test
                    logfile = open("/Users/martinbrown/Desktop/BettingScripts/output/drawnobet_home_suggested.txt" , 'a')
                    if kickwrote == 0:
                        logfile.write('\n')
                        logfile.write('----------------------------------------------------------------------')
                        logfile.write('\n')
