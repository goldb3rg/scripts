...
if __name__ == "__main__":
    ...
    logfile.write("Using odds 9/4, 5/2 or 3/1 for the first goal to be in the region 0 - 10 mins.<br>")
    logfile.write("---------------------------------------------------------------------------------------------------------------------<br>")
    logfile.write('<br>')
    logfile.close()
                    ...
                    if doublechance.find('football-live') == -1:
                        ...
                        if xits != 1 :
                            ...
                            for k in range (1, 100000, 1):
                                ...
                                if test1.find(' Time of 1st Goal ') != -1:
                                    ...
                                    while t == 1:
                                        ...
                                        if test1.find('"nofollow"') != -1:
                                            ...
                                            if (test1.find('data-oc-price-num="9" data-oc-price-den="4"') != -1) \
                                            or (test1.find('data-oc-price-num="5" data-oc-price-den="2"') != -1) \
                                            or (test1.find('data-oc-price-num="3" data-oc-price-den="1"') != -1):
                                                #print test
                                                #print test1
