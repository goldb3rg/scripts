...
if __name__ == "__main__":
    logfile = open("/Volumes/video/TV & Movies/FootyOdds/uk_odds.txt" , 'w')
    logfile.write("Odds taken from Sky Bet - We use Bet Fred. I will change this.")
    logfile.close()
    ...
    if xit != 1 :
        ...
        for j in range (1, 10000, 1):
            ...
            if test.find('<h3 class="section-head"') != -1:
                ...
                logfile = open("/Volumes/video/TV & Movies/FootyOdds/uk_odds.txt" , 'a')
                logfile.write('\n')
                logfile.write('\n** ')
