...
if __name__ == "__main__":
    logfile = open("/Users/martinbrown/Desktop/BettingScripts/output/whopper.txt" , 'w')
    logfile.write("Odds taken from Sky Bet - UK Long List.")
    logfile.close()

    import urllib
    #Reads the web page for the GK players info
    sock = urllib.urlopen("http://www.skybet.com/football/coupon/whopper-long-list")
    ...
    if xit != 1 :
        ...
        for j in range (1, 100000, 1):
            ...
            if test.find('<h3 class="section-head"') != -1:
                ...
                logfile = open("/Users/martinbrown/Desktop/BettingScripts/output/whopper.txt" , 'a')
                logfile.write('\n')
                logfile.write('\n** ')
