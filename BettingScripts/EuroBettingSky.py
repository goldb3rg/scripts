...
if __name__ == "__main__":
    logfile = open("/Users/martinbrown/Desktop/BettingScripts/output/euro_odds.txt" , 'w')
    logfile.write("Odds taken from Sky Bet - European Elite List")
    logfile.close()

    import urllib
    #Reads the web page for the GK players info
    sock = urllib.urlopen("http://www.skybet.com/football/coupon/european-elite-list")
    ...
    if xit != 1 :
        ...
        for j in range (1, 10000, 1):
            ...
            if test.find('<h3 class="section-head"') != -1:
                ...
                logfile = open("/Users/martinbrown/Desktop/BettingScripts/output/euro_odds.txt" , 'a')
                logfile.write('\n')
                logfile.write('\n** ')
