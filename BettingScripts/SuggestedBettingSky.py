...
if __name__ == "__main__":
    logfile = open("/Users/martinbrown/Desktop/BettingScripts/output/uk_suggested.txt" , 'w')
    logfile.write('**********************************************************************')
    logfile.write('\n')
    logfile.write("Suggested UK Games to bet on for Bet 2 with odds 30/100 1/3 2/5 2/9 1/4 2/7 4/11")
    logfile.write('\n')
    logfile.write('**********************************************************************')
    logfile.write('\n')
    logfile.close()

    logfile = open("/Users/martinbrown/Desktop/BettingScripts/output/euro_suggested.txt" , 'w')
    logfile.write('**********************************************************************')
    logfile.write('\n')
    logfile.write("Suggested Euro Games to bet on for Bet 2 with odds 30/100 1/3 2/5 2/9 1/4 2/7 4/11")
    logfile.write('\n')
    logfile.write('**********************************************************************')
    logfile.write('\n')
    logfile.close()
    ...
    if xit != 1 :
        ...
        for j in range (1, 10000, 1):
            ...
            if len(odds) == 7 :
                ...
                if (odds[2] == " 30/100 ") or (odds[2] == " 1/3 ") or (odds[2] == " 2/5 ") or (odds[2] == " 2/9 ") or (odds[2] == " 1/4 ")  or (odds[2] == " 2/7 ") or (odds[2] == " 4/11 "):
                    print "Home Win - " + test
                    logfile = open("/Users/martinbrown/Desktop/BettingScripts/output/euro_suggested.txt" , 'a')
                    if kickwrote == 0:
                        logfile.write('\n')
                        logfile.write('----------------------------------------------------------------------')
                        logfile.write('\n')
