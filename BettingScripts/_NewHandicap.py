...
if __name__ == "__main__":
    ...
    logfile = open("/Users/martinbrown/Desktop/BettingScripts/output/Bet1.html" , 'w')
    logfile.write("Odds taken from Sky Bet -1 Handicap Market (in 90 mins) for Bet 1 on %s %s<br>" % (today.capitalize(),rightnow))
    logfile.write("Using 1/4, 2/7, 30/100, 3/10, 1/3, 4/11, 2/5, 1/2, 8/15, 4/7, 4/9, 8/13, 2/3, 8/11, 4/5, 5/6, 10/11, 19/20, 20/21, 1/1, 21/20, 11/10<br>")
    logfile.write("[H]ome - [D]raw - [A]way<br>")
    ...
    for w in range (1, 6, 1):
        ...
        logfile = open("/Users/martinbrown/Desktop/BettingScripts/output/Bet1.html" , 'a')
        logfile.write('<br>')
        logfile.write('<br>')
                    ...
                    if doublechance.find('football-live') == -1:
                        ...
                        if xits != 1 :
                            ...
                            for k in range (1, 100000, 1):
                                ...
                                if (test1.find('Goal Handicap (-1)') != -1) or (test.find('Handicap Betting') != -1):
                                    dclink = dc[5]
                                    t = 1
                                    hdw = 1
                                    hdwstring = "[H]"
                                    while t == 1:
                                        ...
                                        if test1.find('"nofollow"') != -1:
                                            ...
                                            if ((test1.find('data-oc-price-num="1" data-oc-price-den="4"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="2" data-oc-price-den="7"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="30" data-oc-price-den="100"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="3" data-oc-price-den="10"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="1" data-oc-price-den="3"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="4" data-oc-price-den="11"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="2" data-oc-price-den="5"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="1" data-oc-price-den="2"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="8" data-oc-price-den="15"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="4" data-oc-price-den="7"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="4" data-oc-price-den="9"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="8" data-oc-price-den="13"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="2" data-oc-price-den="3"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="8" data-oc-price-den="11"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="4" data-oc-price-den="5"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="5" data-oc-price-den="6"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="10" data-oc-price-den="11"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="19" data-oc-price-den="20"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="20" data-oc-price-den="21"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="1" data-oc-price-den="1"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="21" data-oc-price-den="20"') != -1) and (test1.find('-1"') != -1)) \
                                            or ((test1.find('data-oc-price-num="11" data-oc-price-den="10"') != -1) and (test1.find('-1"') != -1)):
                                                #print test
                                                #print test1
                                                ...
                                                #print gamelink
                                                gamewrite = gamedata[15] + " " + gamedata[7] + "/" + gamedata[9]
